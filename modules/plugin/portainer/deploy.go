...
import (
	...
	container_portainer_api "github.com/getstackhead/stackhead/modules/container/portainer/api"
...
func (m Module) Deploy(moduleSettings interface{}) error {
	...
	portainerApi := container_portainer_api.Client{Host: host, Port: portainerConfig.Port}
